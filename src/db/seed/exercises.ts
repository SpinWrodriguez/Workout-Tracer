...
export const EXERCISES: Exercise[] = [
  ...
  /* --- From Scottie Scheffler's published training program ----------------- *
   * Six golf-transfer movements, mapped onto this garage: landmine for the
   * lunge-press, gripped plates for the chop, the cable stack for the flies,
   * pull-throughs and rows. Split-stance pull-through and the 90/90 row are
   * variants of rows already seeded, but the position changes the load so
   * much that logging them under the parent would poison its progression.   */
  {
    id: 'lm_lunge_press',
    name: 'Landmine lunge to press',
    station: 'landmine',
    attachment: 'landmine_handle',
    primaryMuscles: ['quads', 'glutes'],
    secondaryMuscles: ['front_delts', 'triceps', 'abs'],
  ...
  {
    id: 'kb_single_leg_chop',
    name: 'Single-leg plate chop',
    station: 'kettlebell',
    primaryMuscles: ['obliques'],
    secondaryMuscles: ['abs', 'glutes', 'front_delts'],
    loadMultiplier: 1.0,
    loadMode: 'weight',
    /* Controlled, not ballistic: the single-leg stance is the exercise, and a
       thrown chop on one foot is a fall. Tempo keeps it out of the explosive
       ordering rules on purpose. */
    gripLoad: 'low',
    isHinge: false,
    isExplosive: false,
    isMobility: false,
  ...
  {
    id: 'mb_tspine_high_knee',
    name: 'T-spine rotation + high knee',
    station: 'bodyweight',
    primaryMuscles: ['obliques'],
    secondaryMuscles: ['upper_back', 'glutes', 'abs'],
    loadMultiplier: 1.0,
    loadMode: 'rpe_only',
    gripLoad: 'none',
    isHinge: false,
  ...
  {
    id: 'cb_split_squat_fly',
    name: 'Split squat reverse fly',
    station: 'cable',
    attachment: 'single_arm',
    primaryMuscles: ['rear_delts'],
    secondaryMuscles: ['upper_back', 'glutes', 'quads'],
    loadMultiplier: CABLE_SINGLE_PULLEY,
    loadMode: 'weight',
    gripLoad: 'low',
    isHinge: false,
  ...
  {
    id: 'cb_split_pull_through',
    name: 'Split-stance pull-through',
    station: 'cable',
    attachment: 'single_arm',
    primaryMuscles: ['glutes', 'hamstrings'],
  ...
  {
    id: 'cb_9090_row',
    name: '90/90 single-arm row',
    station: 'cable',
    attachment: 'single_arm',
    primaryMuscles: ['lats', 'upper_back'],
    /* Rowing out of the floor-seated 90/90 makes the trunk hold the line the
       bench normally holds — the obliques are half the exercise. */
    secondaryMuscles: ['biceps', 'obliques', 'abs'],
    loadMultiplier: CABLE_SINGLE_PULLEY,
    loadMode: 'weight',
    gripLoad: 'low',
    isHinge: false,
